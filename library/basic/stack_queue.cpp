...
template <typename T> inline void Stack<T>::Clear() { this->Size = 0; }
...
template <typename T> inline T Queue<T>::Top() { return this->Arr[this->loc]; }
